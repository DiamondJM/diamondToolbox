classdef sourceLocalizer < handle
    ...
    methods (Static)
        ...
        function chanNames = loadChanNamesFromFile()
            ...
            choice = dlgNonModal( ...
                {'Channel names are used to populate the electrode naming GUI,', ...
                 'so you can assign each detected contact to a named channel.', ...
                 '', ...
                 'If localization is already complete, you can skip this now and', ...
                 'provide chanNames later by manually assigning them to the', ...
                 'sl.chanNames field of the class, or by using sl.loadTimeSeries().', ...
                 'Even if localization is not complete, you can manually input', ...
                 'channel names in the naming GUI.', ...
                 '', ...
                 'Accepted formats:', ...
