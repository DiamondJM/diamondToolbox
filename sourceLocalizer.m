        ...
        function chanNames = loadChanNamesFromFile()
            ...
            choice = questdlg( ...
                {'Channel names are used to populate the electrode naming GUI,', ...
                 ...
                 '', ...
                 'If you skip this now and localization is already complete,', ...
                 'you will not be prompted again. If you still need to run', ...
                 'localization, you will have another chance to provide them.', ...
                 '', ...
                 'Accepted formats:', ...
