...
%  Copyright (C) 2017 Mike Trotta
    ...
    dirs.mr_post        = makedir(fullfile(zloc,'mr_post'));
    dirs.mr_post_dicom  = makedir(fullfile(zloc,'mr_post','dicoms'));
    dirs.mr_post_xfm    = makedir(fullfile(zloc,'mr_post','transform'));
